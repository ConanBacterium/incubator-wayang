...
import org.apache.wayang.basic.operators.{CollectionSource, ObjectFileSource, TableSource, ParquetSource, TextFileSource}
...
class PlanBuilder(private[api] val wayangContext: WayangContext, private var jobName: String = null) {
  ...
  /**
    ...
    * @return [[DataQuanta]] representing the file
    */
  def readParquetFile(url: String): DataQuanta[String] = {
